<main class="container">
    <section class="introduction">
        <div class="astronaut-container">
            <div class="halo"></div>
            <img src="/images/astronauta.webp" alt="Astronaut floating in space" class="astronaut-image">
        </div>
        <div class="introduction-text">
            <h1>Mejora y agiliza tu trabajo</h1>
            <p class="description">Explora una colección de herramientas en la web para impulsar tu
                productividad, ya sea que desarrolles, diseñes o trabajes en el mundo digital.</p>
    ...
    <section class="about">
        ...
        <div class="links-container">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-youtube" width="40" height="40" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
